...
<body>
					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> +880 1990181448</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> mainul080@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
							...
							<div class="brands-name">
								...
								<?php
									...
									foreach($all_published_manufacture as $v_manufacture){?>
										<li><a href="{{URL::to('/brand-wise-product/'.$v_manufacture->manufature_id)}}"> <span class="pull-right">(50)</span>{{{$v_manufacture->manufature_name}}}</a></li>
									<?php } ?>
	...
	<footer id="footer"><!--Footer-->
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">Copyright © 2019 Mainul Hasan All rights reserved.</p>
					<p class="pull-right">Designed by <span><a target="_blank" href="http://www.themeum.com">Mainul Hasan</a></span></p>
				</div>
			</div>
		</div>
