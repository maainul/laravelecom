			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="{{URL::to('/add-manufacture')}}"><i class="icon-eye-open"></i><span class="hidden-tablet"> Add Brands</span></a></li>
						
						<li><a href="{{URL::to('/all-manufacture')}}"><i class="icon-dashboard"></i><span class="hidden-tablet"> All Brands</span></a></li>
						<li>
