			...
			<div class="product-image-wrapper">
				<div class="single-products">
						<div class="productinfo text-center">
						    <img src="{{URL::to($v_product->product_image)}}" style="height: 150px; width: 100px; padding: 0px; margin: 0px;">
				...
				<div class="choose">
					<ul class="nav nav-pills nav-justified">
						<li><a href="{{URL::to('/view-product/'.$v_product->product_id)}}"><i class="fa fa-plus-square"></i>View product</a></li>
